...
# Aggregate rare taxa, normalize by compositional transformation, and merge by 'Type3'
...
# Aggregate rare genera, normalize, and merge by 'Type3'
pseq_genus <- fpomsize %>%
  aggregate_rare(level = "Genus", detection = 5, prevalence = 0.5) %>%
  microbiome::transform("compositional") %>%
