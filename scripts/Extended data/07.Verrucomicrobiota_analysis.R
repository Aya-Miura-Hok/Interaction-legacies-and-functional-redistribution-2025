...
df_phylum$Treatment <- factor(df_phylum$Treatment, levels = c("C", "I", "T"))
...
tukey_df$group1 <- factor(tukey_df$group1, levels = c("C", "I", "T"))
tukey_df$group2 <- factor(tukey_df$group2, levels = c("C", "I", "T"))
